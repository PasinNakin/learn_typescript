...
export const MOCK_PROJECTS = [
    new Project({
        ...
        imageUrl: "../src/assets/placeimg_500_300_arch4.jpg",
        contractTypeId: 3,
    ...
    new Project({
        ...
        imageUrl: "../src/assets/placeimg_500_300_arch1.jpg",
        contractTypeId: 4,
    ...
    new Project({
        ...
        imageUrl: "../src/assets/placeimg_500_300_arch12.jpg",
        contractTypeId: 6,
    ...
    new Project({
        ...
        imageUrl: "../src/assets/placeimg_500_300_arch5.jpg",
        contractTypeId: 4,
